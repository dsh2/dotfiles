...
compdef _gnu_generic autorandr capinfos fzf lnav lspci pstree pv shuf tee tshark tty wireshark pandoc tc bmon nmap nping capinfos teamd teamdctl teamnl
